...
QT_MOC_LITERAL(1, 13, 14), // "acceptFileName"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 9) // "acceptUrl"

    },
    "MyListwidget\0acceptFileName\0\0acceptUrl"
};
...
void MyListwidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->acceptFileName((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->acceptUrl((*reinterpret_cast< QUrl(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyListwidget::acceptFileName)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyListwidget::*)(QUrl );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyListwidget::acceptUrl)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyListwidget::acceptFileName(QString _t1)
{
...
// SIGNAL 1
void MyListwidget::acceptUrl(QUrl _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
